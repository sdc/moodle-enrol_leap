...
/**
 * Strings for component 'enrol_leap', language 'en'.
 *
 * @package    enrol_leap
...
$string['leap:config'] = 'Configure leap enrol instances';
$string['leap:enrol'] = 'Enrol users';
$string['leap:manage'] = 'Manage user enrolments';
$string['leap:unenrol'] = 'Unenrol users from the course';
$string['leap:unenrolself'] = 'Unenrol self from the course';
$string['messageprovider:expiry_notification'] = 'Leap enrolment expiry notifications';
$string['pluginname'] = 'Leap enrolments';
$string['pluginname_desc'] = 'The Leap enrolments plugin allows users to be enrolled manually via a link in the course administration settings, by a user with appropriate permissions such as a teacher. The plugin should normally be enabled, since certain other enrolment plugins, such as self enrolment, require it.';
$string['status'] = 'Enable Leap enrolments';
...
$string['wsnoinstance'] = 'Leap enrolment plugin instance doesn\'t exist or is disabled for the course (id = {$a->courseid})';
