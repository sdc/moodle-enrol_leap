...
/**
 * Enrol Leap external PHPunit tests
 *
 * @package    enrol_leap
 * @category   phpunit
...
require_once($CFG->dirroot . '/enrol/leap/externallib.php');

class enrol_leap_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_enrol_users() {
        ...
        $roleid = $this->assignUserCapability('enrol/leap:enrol', $context1->id);
        ...
        $this->assignUserCapability('enrol/leap:enrol', $context2->id, $roleid);
        ...
        enrol_leap_external::enrol_users(array(
        ...
        $this->unassignUserCapability('enrol/leap:enrol', $context1->id, $roleid);
        try {
            enrol_leap_external::enrol_users(array(
                array('roleid' => 3, 'userid' => $user1->id, 'courseid' => $course1->id),
            ));
        ...
        $this->assignUserCapability('enrol/leap:enrol', $context1->id, $roleid);
        ...
        // Call for course without leap instance.
        $DB->delete_records('user_enrolments');
        ...
        try {
            ...
            $this->fail('Exception expected if course does not have leap instance');
        } catch (moodle_exception $e) {
