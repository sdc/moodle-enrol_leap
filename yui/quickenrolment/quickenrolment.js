YUI.add('moodle-enrol_leap-quickenrolment', function(Y) {
    ...
    Y.extend(USERENROLLER, Y.Base, {
        ...
        initializer : function(config) {
                ...
                .append(create('<div class="'+CSS.WRAP+'"></div>')
                    ...
                    .append(create('<div class="'+CSS.CONTENT+'"></div>')
                        .append(create('<div class="'+CSS.SEARCHCONTROLS+'"></div>')
                            .append(create('<div class="'+CSS.ENROLMENTOPTION+' '+CSS.ROLE+'"><label for="id_enrol_leap_assignable_roles">'+M.str.role.assignroles+'</label></div>')
                                    .append(create('<select id="id_enrol_leap_assignable_roles"><option value="">'+M.str.enrol.none+'</option></select>'))
                            )
            ...
            Y.all('.enrol_leap_plugin input').each(function(node){
            ...
            if (this.get(UEP.COHORTSAVAILABLE)) {
                this.get(UEP.BASE).one('.'+CSS.ENTITYSELECTOR)
                    .append(create('<input type="radio" id="id_enrol_leap_entity_users" name="enrol_leap_entity" value="users" checked="checked"/>'))
                    .append(create('<label for="id_enrol_leap_entity_users">'+ M.str.enrol_leap.browseusers+'</label>'))
                    .append(create('<input type="radio" id="id_enrol_leap_entity_cohorts" name="enrol_leap_entity" value="cohorts"/>'))
                    .append(create('<label for="id_enrol_leap_entity_cohorts">'+M.str.enrol_leap.browsecohorts+'</label>'));
                this.get(UEP.BASE).one('#id_enrol_leap_entity_cohorts').on('change', this.search, this);
                this.get(UEP.BASE).one('#id_enrol_leap_entity_users').on('change', this.search, this);
            } else {
                this.get(UEP.BASE).one('.'+CSS.ENTITYSELECTOR)
                    .append(create('<input type="hidden" name="enrol_leap_entity" value="users"/>'));
            }
        ...
        populateAssignableRoles : function() {
            this.on('assignablerolesloaded', function(){
                ...
                Y.one('#id_enrol_leap_assignable_roles').focus();
            }, this);
        ...
        show : function(e) {
            ...
            var rolesselect = Y.one('#id_enrol_leap_assignable_roles');
            if (rolesselect) {
                rolesselect.focus();
            }
        },
        ...
        currentEntity : function() {
            var entity = CSS.USER;
            var cohortsinput = Y.one('#id_enrol_leap_entity_cohorts');
    ...
    M.enrol_leap = M.enrol_leap || {};
    M.enrol_leap.quickenrolment = {
        init : function(cfg) {
