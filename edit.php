...
/**
 * Adds new instance of enrol_leap to specified course
...
require_capability('enrol/leap:config', $context);

$PAGE->set_url('/enrol/leap/edit.php', array('courseid'=>$course->id));
...
$plugin = enrol_get_plugin('leap');

if ($instances = $DB->get_records('enrol', array('courseid'=>$course->id, 'enrol'=>'leap'), 'id ASC')) {
...
$mform = new enrol_leap_edit_form(null, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_leap'));
$PAGE->set_heading($course->fullname);

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_leap'));
$mform->display();
echo $OUTPUT->footer();
